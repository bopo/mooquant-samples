...
if __name__ == '__main__':
    ...
    feed.addBarsFromCSV("fd", "./data/600036.csv")

    # 3.broker setting
    # 3.1 commission类设置
    commission = broker.backtesting.TradePercentage(0.00018)
    ...
    # 3.3完善broker类
    brk = broker.backtesting.Broker(50000, feed, commission)
    ...
    print ("total number of trades: %d" % trade.getCount())
    # print (trade.getCount())

    print ("commissions for each trade: %s" % trade.getCommissionsForAllTrades())
